...
public class TP4 {
 ...
 Student student = new Student ("student1", "student1", "student@email.com", 12345L, 15.0, Classe.IA1_2, 
         Status.NON_REDOUBLANT);
 student.displayInfo();
 ...
 Staff staffMember = new Staff ("member1", "member1", "member1@email.com", 11111L,"Engineer", 5, new ArrayList(List.of("Task1", "Task2", "Task3")));
